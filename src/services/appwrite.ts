...
// Appwrite IDs
export const DATABASE_ID = import.meta.env.VITE_APPWRITE_DB_ID as string;

export const STORAGE_FILE_BUCKET_ID = import.meta.env.VITE_APPWRITE_STORAGE_FILE_BUCKET_ID as string;
export const STORAGE_BLOGS_BUCKET_ID = import.meta.env.VITE_APPWRITE_STORAGE_BLOGS_BUCKET_ID as string;

export const COLLECTION_PROFILE_ID = import.meta.env.VITE_APPWRITE_DB_PROFILE_COLLECTION_ID as string;
export const COLLECTION_PROJECTS_ID = import.meta.env.VITE_APPWRITE_DB_PROJECTS_COLLECTION_ID as string;
export const COLLECTION_BLOG_ID = import.meta.env.VITE_APPWRITE_DB_BLOG_COLLECTION_ID as string;
export const COLLECTION_SECTION_VISIBILITY_ID = import.meta.env.VITE_APPWRITE_DB_SECTION_VISIBILITY_COLLECTION_ID as string;
export const COLLECTION_RESUME_ID = import.meta.env.VITE_APPWRITE_DB_RESUME_COLLECTION_ID as string;
...
export const getProject = async (projectId: string): Promise<Models.Document & ProjectData> => {
	try {
		return (await databases.getDocument(
			...
			projectId,
		)) as Models.Document & ProjectData;
	} catch (error) {
...
export const uploadContentImage = async (file: File): Promise<{ fileId: string; url: string }> => {
	try {
		...
		return { fileId, url } as unknown as { fileId: string; url: string };
	} catch (error) {
...
export const getContentImagePreviewUrl = (fileId: string): string => {
	return storage.getFileView(STORAGE_BLOGS_BUCKET_ID, fileId) as unknown as string;
};
